...
def test_get_diagonal_square_between():
    ...
    assert (get_diagonal_square_between('a1', 'h8')) == [
        'b2', 'c3', 'd4', 'e5', 'f6', 'g7']
    ...
    assert (get_diagonal_square_between('g2', 'b7')) == [
        'f3', 'e4', 'd5', 'c6']
...
def test_break_down_knight_move():
    ...
    assert (break_down_knight_move(('b1', 'c3'))) == (
        ('b1', 'b3'), ('b3', 'c3'))
    assert (break_down_knight_move(('c3', 'e4'))) == (
        ('c3', 'e3'), ('e3', 'e4'))
    assert (break_down_knight_move(('g8', 'f6'))) == (
        ('g8', 'g6'), ('g6', 'f6'))
    assert (break_down_knight_move(('f6', 'd5'))) == (
        ('f6', 'd6'), ('d6', 'd5'))
    assert (break_down_knight_move(('d5', 'f6'))) == (
        ('d5', 'f5'), ('f5', 'f6'))
